    ...
    public partial class initalMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AvaliableTabels", x => x.TableId);
                    table.ForeignKey(
                        name: "FK_AvaliableTabels_Clients_ClientId",
                        column: x => x.ClientId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AvaliableTabels_ClientId",
                table: "AvaliableTabels",
                column: "ClientId");
